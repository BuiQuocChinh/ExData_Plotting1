#This R script is used to produce the plot2 for the Assignment 1
...
plot(SubData$Time , SubData$Global_active_power, type = "n", xlab = "", ylab = "Global Active Power (kilowatts)")
